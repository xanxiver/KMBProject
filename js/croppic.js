...
(function (window, document) {
	...
	Croppic.prototype = {
		...
		bindImgUploadControl: function(){
            ...
            var formHtml = '<form class="' + that.id + '_imgUploadForm" style="display: none; visibility: hidden;enctype="multipart/form-data">;">  <input type="file" name="img" id="' + that.id + '_imgUploadField" accept="image/*">  </form>';
